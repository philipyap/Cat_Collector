...
urlpatterns = [
    # when it hits to the path, it import to views we just made.
    # The name parameter provides an identifier we can use in other parts of Django to refer to this URL.
